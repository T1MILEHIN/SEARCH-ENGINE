        ...
        <div className="z-10 w-[95%] md:w-[60%] bg-blur md:p-5 p-2">
            ...
            <form onSubmit={onSubmit} action="">
                <div className="my-5 flex gap-5">
                    <input type="text" ref={search} name="search" id="search" className="pl-2 font-bold border-black border-2 placeholder:text-black text-xl placeholder:font-bold placeholder:tracking-wider w-full h-10 md:h-12 rounded-md focus:ring duration-300" placeholder="Search Here" />
